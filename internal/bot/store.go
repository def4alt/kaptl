...
type Store interface {
	...
	SetBudget(ctx context.Context, userID, categoryID int64, intervalDays, intervalMonths int, amount float64) (*models.Budget, error)
	GetBudgetSummary(ctx context.Context, userID int64, periodOffset int) ([]models.BudgetRow, error)
